...
export const FloatingButton = () => {
    ...
    const handleMouseMove = (e) => {
        ...
        const maxX = window.innerWidth - 100; // 100 là ước lượng chiều rộng của button
        const maxY = window.innerHeight - 100; // 100 là ước lượng chiều cao của button
    ...
    return (
        ...
        >
            {/* Main Button */}
            <div className="text-white shadow-xl flex items-center justify-center p-3 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500">
