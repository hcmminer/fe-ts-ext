...
export const FloatingButton = () => {
    ...
    return (
        ...
        >
            {/* Main Button */}
            <div className="relative text-white shadow-xl flex items-center justify-center p-3 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500">
            ...
            <div className="absolute top-0 left-0 w-full h-full">
                ...
                <div
                    ...
                    flex p-2 hover:p-3 bg-green-300 hover:bg-green-400 text-white shadow-lg"
                >
                ...
                <div
                    ...
                    flex p-2 hover:p-3 bg-blue-300 hover:bg-blue-400 text-white shadow-lg"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
                ...
                <div
                    ...
                    opacity-0 group-hover:opacity-100 scale-0 group-hover:scale-100
                    -top-10 -left-10
                    flex p-2 hover:p-3 bg-yellow-300 hover:bg-yellow-400 text-white shadow-lg"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
